...
public class ManagePharmacy extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pharmacyTable.setBackground(new java.awt.Color(0, 153, 153));
        pharmacyTable.setForeground(new java.awt.Color(255, 255, 255));
        ...
        btnAddPharmacy.setBackground(new java.awt.Color(0, 204, 153));
